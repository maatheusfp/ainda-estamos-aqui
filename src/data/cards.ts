...
export const gameCards: Card[] = [
  // Cartas Assistente (8 cartas - escolher 1 de 3 notícias para capa)
  {
    id: 'assist_1',
    type: 'assistente',
  ...
  // Cartas Informante (4 cartas - notícias contra governo/pró população)
  {
    id: 'inform_1',
    type: 'informante',
  ...
  // Cartas Agente do Governo (4 cartas - notícias pró governo)
  {
    id: 'agent_1',
    type: 'agente',
